...
public class LoginPage extends JFrame implements ActionListener {
    ...
    LoginPage(){
        ...
        setTitle("INSURANCE MANAGEMENT SYSTEM USER");
    ...
    void  loginx(){
        ...
        if (rs.next()){
            ...
            String query1 = "select name from signup where username = '"+username2+"' and password = '"+password2+"';";
            ResultSet rs1 = conn.sta.executeQuery(query1);
            if (rs1.next()){
                FULL_NAME = rs1.getString(1);
            }
            //end of retriving
